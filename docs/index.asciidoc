...
Few examples of optional parameters (more general/vendor-specific options can be found at https://github.com/jeremyevans/sequel/blob/master/doc/opening_databases.rdoc):
   
|==========================================================
|max_connections | The maximum number of connections the connection pool
|jdbc_properties | A hash for properties to be set on the JDBC driver
|==========================================================

Example to pass properties to JDBC clients:
[source,ruby]
-------------------------------------------------------
input {
  jdbc {
